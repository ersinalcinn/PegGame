...
public class Writer : MonoBehaviour
{
    ...
    { 
        ...
        {
            LetterPos = new Vector3(empty.transform.position.x, empty.transform.position.y, empty.transform.position.z + 0 + fontwidth);
    ...
    public void TextBox(string _Text)
    {
        Textbox = _Text;
    }
    ...
    public void width(float width)
    {
        ...
        foreach (Transform child in empty.transform)
        {
            ...
            child.transform.GetComponentInChildren<Transform>().localPosition = Vector3.right * -_width* incrament;
            incrament++;
        }
    }
    ...
    public void AddModuleToLetters()
    {
        float newDelay = 0.0f;
        foreach (Transform child in empty.transform)
        {
